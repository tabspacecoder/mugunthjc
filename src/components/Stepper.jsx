...
export default function Stepper({
  ...
  return (
    <div
      className="flex ml-0 pl-0 min-h-full flex-1 flex-col items-start justify-start p-4 sm:aspect-[4/3] md:aspect-[2/1]"
      {...rest}
    >
      <div
...
function StepConnector({ isComplete }) {
  ...
  return (
    <div className="relative mx-2 h-0.5 flex-1 overflow-hidden rounded bg-gray-700 pointer-events-none">
      <motion.div
